    ...
    containers: [
      {
        ...
        low: 3,
        vulnerabilities: [
          { description: 'Privileged Access', severity: 'High' },
          { description: 'Weak Encryption', severity: 'Medium' },
          { description: 'Old Dependencies', severity: 'Low' },
        ],
      },
      {
        containerName: 'Container 2',
        ...
        low: 1,
        vulnerabilities: [
          { description: 'Deprecated Libraries', severity: 'Low' },
        ],
      },
    ],
  },
